<template>
  <section class="admin-content">
    <el-card class="panel" shadow="never">
      <div class="panel-title">活动记录</div>
      <el-space wrap style="margin-bottom: 12px">
        <el-button type="primary" plain @click="$emit('open-create')">新增活动记录</el-button>
      </el-space>
      <el-table :data="recordData" size="small" border stripe>
        ...
        <el-table-column prop="activityLevel" label="活动水平" width="120" />
